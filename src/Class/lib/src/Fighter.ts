    ...
    show(fighter?: Fighter) {
        ...
        const embed = new EmbedBuilder()
            ...
            .setFields([
                ...
                {
                    name: "Attack",
                    value: inlineCode(Math.round(this.attack).toString()),
                    inline: true,
                },
                {
                    name: "HP",
                    value: inlineCode(Math.round(this.hp).toString()),
                    inline: true,
                },
                { name: "Armor", value: inlineCode(armor), inline: true },
                {
                    name: "Crit Chance",
                    value: inlineCode(critChance),
                    inline: true,
                },
                {
                    name: "Crit Damage",
                    value: inlineCode(`x${this.critDamage.toFixed(1)}`),
                    inline: true,
                },
                {
                    name: "Skill",
